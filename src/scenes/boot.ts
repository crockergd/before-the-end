...
export default class Boot extends AbstractScene {
    ...
    private load_assets(): void {
        ...
        this.load.spritesheet('mercenary', require_tilesheet('./mercenary.png'), { frameWidth: 53, frameHeight: 82 });
        ...
        this.load.image('dart', require_image('./dart.png'));
        this.load.image('swing_wide', require_image('./swing_wide.png'));
